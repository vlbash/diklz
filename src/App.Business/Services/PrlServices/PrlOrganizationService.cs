...
{
    public interface IPrlOrganizationService
    {
        ICommonDataService DataService { get; }
        Task<Dictionary<string, string>> SaveNewOrg(PrlOrganizationExtFullDTO arg);
    }

    public class PrlOrganizationService: IPrlOrganizationService
    {
        public ICommonDataService DataService { get; }
        private readonly IObjectMapper _objectMapper;

        public PrlOrganizationService(ICommonDataService dataService, IObjectMapper objectMapper)
        {
            DataService = dataService;
            _objectMapper = objectMapper;
        }

        public async Task<Dictionary<string, string>> SaveNewOrg(PrlOrganizationExtFullDTO orgDto)
        {
