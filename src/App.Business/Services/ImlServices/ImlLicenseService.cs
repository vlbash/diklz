...
{
    public class ImlLicenseService : IImlLicenseService
    {
        ...
        public ImlLicenseService(ICommonDataService commonDataService, IUserInfoService infoService, IOperationFormListService formListService)
        {
        ...
        {
            var licenseId = _commonDataService.GetEntity<ImlLicense>(license =>
                license.OrgUnitId == orgId && license.LicType == "IML" && license.IsRelevant && license.LicState == "Active").ToList();
