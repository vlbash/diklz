...
{
    public class ProxyHandlerFilter: IResultFilter
    {
        ...
        public void OnResultExecuting(ResultExecutingContext context)
        {
            ...
            try
            {
                ...
                if (requestType == "GET" || requestType == "POST")
                    status = HandleRequest(context.HttpContext).Result;
                else
                    status = HttpStatusCode.BadRequest;
            }
            catch (Exception e)
            {
                context.HttpContext.Response.WriteAsync("Виникла помилка при обробці запиту" + e).RunSynchronously();
                return;
            }
            finally
            {
                ...
                {
                    context.HttpContext.Response.WriteAsync("Виникла помилка при обробці запиту").RunSynchronously();
