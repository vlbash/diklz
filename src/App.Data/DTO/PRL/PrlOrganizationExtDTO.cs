...
{
    public class PrlOrganizationExtShortDTO : BaseDTO/*, IOrgUnitDetailDTO*/
    {
    ...
    public class PrlOrganizationExtMediumDTO: BaseDTO/*, IOrgUnitDetailDTO*/
    {
        [DisplayName("Назва організації")]
        public string Name { get; set; }
    ...
    public class PrlOrganizationExtFullDTO: BaseDTO
    {
    ...
    public class PrlOrganizationExtListDTO: BaseDTO, IOrgUnitListDTO, IPagingCounted
    {
