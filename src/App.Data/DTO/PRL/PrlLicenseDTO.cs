...
namespace App.Data.DTO.PRL
{
    ...
    public class PrlLicenseDetailDTO: BaseDTO
    {
        [NotMapped]
        ...
        [DisplayName("Вид діяльності")] public string LicType { get; set; }

        [DisplayName("Вид діяльності")] public string LicTypeName { get; set; }

        public string LicSort { get; set; }

        [DisplayName("Стан ліцензії")] public string LicState { get; set; }

        public bool IsRelevant { get; set; }

        [DisplayName("Стан ліцензії")] public string LicStateName { get; set; }

        [DisplayName("Номер ліцензії")] public string LicenseNumber { get; set; }
        ...
        [DisplayName("ПІБ")] public string Name { get; set; }

        [DisplayName("Підстава")] public string AppSortEnum { get; set; }

        [DisplayName("Підстава")] public string EndReasonText { get; set; }

        [DisplayName("№ Наказу")] public string EndOrderNumber { get; set; }

        [DisplayName("Дата наказу")] public DateTime? EndOrderDate { get; set; }

        [DisplayName("Текст наказу")] public string EndOrderText { get; set; }
        ...
        [DisplayName("Серія паспорта")] public string PassportSerial { get; set; }

        [DisplayName("Номер паспорта")] public string PassportNumber { get; set; }
        ...
        [Display(Name = "Форма власності")] public string OwnershipType { get; set; }
        ...
        [NotMapped]
        public string MedicinalForms { get; set; }
        ...
        [NotMapped]
        public string ProdResearchDrugs { get; set; }

        [NotMapped] public IEnumerable<PrlAppListDTO> ApplicationList { get; set; }
    ...
    [RightsCheckList(nameof(LimsDoc))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class PrlLicenseListDTO: BaseDTO, IPagingCounted
    {
        [NotMapped]
        public OrgType OrgType
        {
    ...
    public class PrlLicenseRegisterListDTO: BaseDTO, IPagingCounted
    {
        [PredicateCase(PredicateOperation.Contains)]
        [Display(Name = "ЄДРПОУ/РНОКПП (Індивідуальний податковий номер)")]
        public string EDRPOU { get; set; }
    ...
    public class PrlLicenseRegisterDetailDTO: BaseDTO
    {
        public Guid BaseApplicationId { get; set; }
