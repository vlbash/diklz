...
{
    public class AppOrganizationExtShortDTO: BaseDTO
    {
        [NotMapped]
        public string IdLiceType { get; set; }
        ...
        [NotMapped]
        public string License => LicType == "PRL" ? "Виробництво" : LicType == "IML" ? "Імпорт" : "Торгівля";
    }

    public class AppOrganizationExtMediumDTO: BaseDTO
    {
        [NotMapped]
        public string IdLiceType { get; set; }
    ...
    public class AppOrganizationExtFullDTO: BaseDTO
    {
        [NotMapped]
        public string IdLiceType { get; set; }
