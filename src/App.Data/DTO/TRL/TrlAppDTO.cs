...
{
    [RightsCheckList(nameof(TrlApplication))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class TrlAppDetailDTO: BaseAppDetailDTO
    {
        [DisplayName("Вид діяльності")]
        [NotMapped]
        public List<Guid> ListOfTrlActivityType { get; set; }
        ...
        public string PerformerOfExpertiseString { get; set; }
    }

    [RightsCheckList(nameof(TrlApplication))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class TrlAppEditDTO: BaseAppEditDTO
    {
    ...
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class TrlAppListDTO: BaseDTO, IPagingCounted
    {
    ...
    [RightsCheckList(nameof(TrlApplication))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class TrlAppExpertiseDTO : BaseDTO
    {
        public Guid OrgUnitId { get; set; }
