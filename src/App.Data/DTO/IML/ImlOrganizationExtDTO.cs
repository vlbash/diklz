...
{
    public class ImlOrganizationExtShortDTO : BaseDTO/*, IOrgUnitDetailDTO*/
    {
    ...
    public class ImlOrganizationExtMediumDTO: BaseDTO/*, IOrgUnitDetailDTO*/
    {
        [DisplayName("Назва організації")]
        public string Name { get; set; }
    ...
    public class ImlOrganizationExtFullDTO: BaseDTO
    {
    ...
    public class ImlOrganizationExtListDTO: BaseDTO, IOrgUnitListDTO, IPagingCounted
    {
