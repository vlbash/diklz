...
namespace App.Data.DTO.IML
{
    ...
    public class ImlLicenseDetailDTO: BaseDTO
    {
        [NotMapped]
        ...
        [NotMapped] public IEnumerable<ImlAppListDTO> ApplicationList { get; set; }
    ...
    [RightsCheckList(nameof(LimsDoc))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class ImlLicenseListDTO: BaseDTO, IPagingCounted
    {
        [NotMapped]
        public OrgType OrgType
        {
    ...
    public class ImlLicenseRegisterListDTO: BaseDTO, IPagingCounted
    {
        [PredicateCase(PredicateOperation.Contains)]
        [Display(Name = "ЄДРПОУ/РНОКПП (Індивідуальний податковий номер)")]
        public string EDRPOU { get; set; }
    ...
    public class ImlLicenseRegisterDetailDTO: BaseDTO
    {
        public Guid BaseApplicationId { get; set; }
