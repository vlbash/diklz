...
{
    [RightsCheckList(nameof(ImlApplication))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class ImlAppDetailDTO: BaseAppDetailDTO
    {
    ...
    [RightsCheckList(nameof(ImlApplication))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class ImlAppEditDTO: BaseAppEditDTO
    {
    }

    [RightsCheckList(nameof(LimsDoc))]
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class ImlAppListDTO: BaseDTO, IPagingCounted
    {
    ...
    [RlsRight(nameof(OrganizationExt), nameof(OrgUnitId))]
    public class ImlAppExpertiseDTO : BaseDTO
    {
        public Guid OrgUnitId { get; set; }
