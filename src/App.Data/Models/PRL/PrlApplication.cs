...
{
    public class PrlApplication: BaseApplication, ILimsDoc, IDerivedEntity
    {
        #region ILimsDoc
        ...
        static Type _type = typeof(PrlApplication);

        static IMapper _mapper = new MapperConfiguration(cfg => cfg.CreateMap<PrlApplication, LimsDoc>()
