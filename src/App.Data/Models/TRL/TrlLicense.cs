...
{
    public class TrlLicense: BaseLicense, ILimsDoc, IDerivedEntity
    {
        #region ILimsDoc
        ...
        static Type _type = typeof(TrlLicense);

        static IMapper _mapper = new MapperConfiguration(cfg => cfg.CreateMap<TrlLicense, LimsDoc>()
