...
{
    public class ImlLicense: BaseLicense, ILimsDoc, IDerivedEntity
    {
        #region ILimsDoc
        ...
        static Type _type = typeof(ImlLicense);

        static IMapper _mapper = new MapperConfiguration(cfg => cfg.CreateMap<ImlLicense, LimsDoc>()
