...
namespace App.Data.Models.IML
{
    public class ImlApplication: BaseApplication, ILimsDoc, IDerivedEntity
    {
        #region ILimsDoc
        ...
        static Type _type = typeof(ImlApplication);

        static IMapper _mapper = new MapperConfiguration(cfg => cfg.CreateMap<ImlApplication, LimsDoc>()
