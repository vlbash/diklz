...
namespace App.Data.Migrations
{
    ...
    [Migration("20190722134338_v1.11")]
    partial class v111
    {
            ...
            modelBuilder.Entity("App.Data.Models.IML.ImlMedicine", b =>
                {
                    ...
                    b.Property<Guid>("ProducerCountryId")
                        .HasColumnName("producer_country_id")
                        .HasMaxLength(200);
                    ...
                    b.Property<Guid>("SupplierCountryId")
                        .HasColumnName("supplier_country_id")
                        .HasMaxLength(200);
                    ...
                    b.HasIndex("ProducerCountryId")
                        .HasName("ix_iml_medicines_producer_country_id");

                    b.HasIndex("SupplierCountryId")
                        .HasName("ix_iml_medicines_supplier_country_id");
            ...
            modelBuilder.Entity("App.Data.Models.IML.ImlMedicine", b =>
                {
                    ...
                    b.HasOne("App.Core.Data.Entities.ATU.Country", "ProducerCountry")
                        .WithMany()
                        .HasForeignKey("ProducerCountryId")
                        .HasConstraintName("fk_iml_medicines_atu_country_producer_country_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("App.Core.Data.Entities.ATU.Country", "SupplierCountry")
                        .WithMany()
                        .HasForeignKey("SupplierCountryId")
                        .HasConstraintName("fk_iml_medicines_atu_country_supplier_country_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
