...
namespace ReflectionIT.Mvc.Paging {
    ...
    public class PagingList<T> : List<T>, IPagingList<T> where T : class {
        ...
        internal PagingList(IEnumerable<T> list, int pageSize, int pageIndex, int pageCount, int totalRecordCount)
            : base(list) {
            this.TotalRecordCount = totalRecordCount;
            this.PageIndex = pageIndex;
            this.PageCount = pageCount;
            this.Action = "Index";
            this.PageParameterName = "pg_Page";
            this.SortExpressionParameterName = "pg_SortExpression";
        }

        internal PagingList(IEnumerable<T> list, int pageSize, int pageIndex, int pageCount, string sortExpression, string defaultSortExpression, int totalRecordCount)
