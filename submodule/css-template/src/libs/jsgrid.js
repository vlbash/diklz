...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        rowClick: function(args) {
            if(this.editing) {
                this.editItem($(args.event.target).closest('.jsgrid-tr'));
            }
        },
        rowDoubleClick: $.noop,

        noDataContent: "Не знайдено",
        ...
        pagerClass: "jsgrid-pager pagination",
        pagerNavButtonClass: "jsgrid-pager-nav-button",
        pagerNavButtonInactiveClass: "jsgrid-pager-nav-inactive-button",
        pageClass: "jsgrid-pager-page",
        currentPageClass: "jsgrid-pager-current-page active",
        ...
        _createHeader: function() {
            ...
            var $headerGrid = this._headerGrid = $("<div>").addClass(this.tableClass)
                .append($headerRow)
                .append($filterRow)
                .append($insertRow);
        ...
        _createBody: function() {
            var $content = this._content = $("<div>");
                $content.addClass('jsgrid-table-body')

            var $bodyGrid = this._bodyGrid = $("<div>").addClass(this.tableClass)
                .append($content);
        ...
        _createHeaderRow: function() {
            ...
            var $result = $("<div>").addClass(this.headerRowClass).addClass('jsgrid-tr');

            this._eachField(function(field, index) {
                var $th = this._prepareCell("<div>", field, "headercss", this.headerCellClass)
        ...
        _createFilterRow: function() {
            ...
            var $result = $("<div>").addClass(this.filterRowClass).addClass('jsgrid-tr');

            this._eachField(function(field) {
                this._prepareCell("<div>", field, "filtercss")
        ...
        _createInsertRow: function() {
            ...
            var $result = $("<div>").addClass(this.insertRowClass).addClass('jsgrid-tr');

            this._eachField(function(field) {
                this._prepareCell("<div>", field, "insertcss")
        ...
        _createNoDataRow: function() {
            ...
            return $("<div>").addClass(this.noDataRowClass).addClass('jsgrid-tr')
                .append($("<div>").addClass(this.cellClass).attr("colspan", amountOfFields)
        ...
        _createCell: function(item, field) {
            ...
            if($.isFunction(field.cellRenderer)) {
                ...
                $result = $("<div>").append(this.renderTemplate(field.itemTemplate || fieldValue, field, args));
            }
        ...
        _clearSortingCss: function() {
            this._headerRow.find(".jsgrid-header-cell")
        ...
        _setSortingCss: function() {
            ...
            this._headerRow.find(".jsgrid-header-cell").eq(fieldIndex)
        ...
        rowByItem: function(item) {
            ...
            return this._content.find('.jsgrid-tr').filter(function() {
        ...
        _createEditRow: function(item) {
            ...
            var $result = $("<div>").addClass(this.editRowClass).addClass('jsgrid-tr');

            this._eachField(function(field) {
                var fieldValue = this._getItemFieldValue(item, field);

                this._prepareCell("<div>", field, "editcss")
...
// console.log(event,item)
        ...
        mt.createDialog(event,msg,confirmDialog,refuseDialog)
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        buttonClass: "jsgrid-button btn btn-square btn-tiny icon",
        modeButtonClass: "jsgrid-mode-button btn-secondary",

        modeOnButtonClass: "jsgrid-mode-on-button btn-primary-border icon-md icon-minus",
        searchModeButtonClass: "jsgrid-search-mode-button icon-lg icon-search-file ",
        insertModeButtonClass: "jsgrid-insert-mode-button icon-md icon-plus",
        editButtonClass: "jsgrid-edit-button btn-secondary-border icon-md icon-edit-line",
        deleteButtonClass: "jsgrid-delete-button btn-danger-border icon-md icon-remove",
        searchButtonClass: "jsgrid-search-button btn-primary-border icon-lg icon-filter-outline",
        clearFilterButtonClass: "jsgrid-clear-filter-button  icon-lg icon-filter-remove-outline btn-primary-border",
        insertButtonClass: "jsgrid-insert-button btn-primary-border icon-md icon-plus",
        updateButtonClass: "jsgrid-update-button btn-success-border icon-md icon-check",
        cancelEditButtonClass: "jsgrid-cancel-edit-button icon-md icon-close btn-danger-border",

        searchModeButtonTooltip: "Пошук",
        insertModeButtonTooltip: "Додати",
        editButtonTooltip: "Редагувати",
        deleteButtonTooltip: "Видалити",
        searchButtonTooltip: "Знайти",
        clearFilterButtonTooltip: "Очистити фільтр",
        insertButtonTooltip: "Додати",
        updateButtonTooltip: "Оновити",
        cancelEditButtonTooltip: "Відмінити редагування",
        ...
        _createModeSwitchButton: function() {
            ...
            var updateButtonState = $.proxy(function() {
                $button.attr("data-title", isInserting ? this.searchModeButtonTooltip : this.insertModeButtonTooltip)
                .attr("data-tooltipright","true")
        ...
        _createGridButton: function(cls, tooltip, clickHandler,tooltipSide) {
            var grid = this._grid;

            var btn =  $("<span>").addClass(this.buttonClass)
                .addClass(cls)
                .attr({
                    title: tooltip
                })
                ...
                if(tooltipSide){
                    if(tooltipSide == "left"){
                        btn.attr("data-tooltipleft","true")
                    }else  if(tooltipSide =="right"){
                        btn.attr("data-tooltipright","true")
                    }
                }
                mt.tooltipEl(btn);
